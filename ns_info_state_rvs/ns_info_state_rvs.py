...
source_dir = os.path.join("scm_implementation","ns_info_state_rvs")
...
alphas = {fn.split(".")[0]: load(os.path.join(source_dir, "alpha", fn))
                     for fn in os.listdir(os.path.join(source_dir, "alpha"))}
